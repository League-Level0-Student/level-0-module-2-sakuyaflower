...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			paperImage = new ImageIcon(getClass().getResource("Paper_sheet.png"));
			scissorsImage = new ImageIcon(getClass().getResource("orange-and-blue-scissors.jpg"));
    ...
    public void actionPerformed(ActionEvent e) {
		...
		opponentSelection = gen.nextInt(2) + 0 ;
